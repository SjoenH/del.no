# Del Nu OpenAPI Specification
[![Build Status](https://travis-ci.org/SjoenH/del.no.svg?branch=master)](https://travis-ci.org/SjoenH/del.no)
...
6. If you did everything correct, https://sjoenh.github.io/del.no/ will lead to your new docs
...
- Documentation(ReDoc): https://sjoenh.github.io/del.no/
- SwaggerUI: https://sjoenh.github.io/del.no/swagger-ui/
- Look full spec:
    + JSON https://sjoenh.github.io/del.no/swagger.json
    + YAML https://sjoenh.github.io/del.no/swagger.yaml
- Preview spec version for branch `[branch]`: https://sjoenh.github.io/del.no/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://sjoenh.github.io/del.no/ with url from the message: `Server started <url>`
